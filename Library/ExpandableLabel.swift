...
class ExpandableLabel :UILabel {
    ...
    func addReadMoreButton()
    {
        ...
        if theNumberOfLines > 2
        {
            ...
            let button = UIButton(frame: CGRect(x: widthLbl-20, y: height-15, width: 70, height: 15))
            button.tag = 9090
            ...
            NSLayoutConstraint.activate([
                ...
                button.bottomAnchor.constraint(equalTo:  self.bottomAnchor, constant: 28),
